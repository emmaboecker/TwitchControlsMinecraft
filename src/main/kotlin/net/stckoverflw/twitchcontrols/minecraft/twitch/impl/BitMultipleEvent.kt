...
const val bitMultipleId = "bit-cheer-multiple"

object BitMultipleEvent :
    TwitchEvent<BitMultipleEventData, ChannelBitsEvent>(bitMultipleId, ChannelBitsEvent::class.java) {
    ...
    override fun gui(player: PlayerEntity): Gui =
        igui(GuiType.NINE_BY_FIVE, "§9Bits cheered (action is repeated for every bit cheered)".literal, 1) {
    ...
    override fun runEvent(
        ...
        eventData: BitMultipleEventData,
        player: PlayerEntity
    ): Pair<Boolean, String> {
